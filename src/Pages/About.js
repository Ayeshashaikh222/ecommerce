...
const About = () => {
    ...
    return (
        ...
        <Container>
            <p
        className="display-5 text-center p-3 bg-secondary mt-1 "
        style={{ fontSize: "6em", fontFamily: "bold" }}
      >
        The Generics
      </p>
            <h2 style={{ textAlign: "center", color:'black' }}>About</h2>
             <Image src="https://prasadyash2411.github.io/ecom-website/img/Band%20Members.png" alt="Logo" roundedCircle style={{
            width: "200px",
            height: "200px",
            objectFit: "cover",
            float: "left",
